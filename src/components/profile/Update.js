...
export default function Update({ history }) {
    ...
    console.log("in Update, user is " + user);
    const initialValues = {
        //  title: user.title,
                ...
                <Form>
                    ...
                    <div className="form-row">
                        <div className="form-group col">
                            <label>Prefix</label>
                            <Field name="prefix" as="select" className={'form-control' + (errors.title && touched.title ? ' is-invalid' : '')}>
                                <option value=""></option>
                    ...
                    <div className="form-group">
                        ...
                        <Link to="/home/profile/details" className="btn btn-link">Cancel</Link>
                    </div>
                </Form>
            )}
        </Formik>
